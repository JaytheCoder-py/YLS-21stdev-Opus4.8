...
export function WorldMap({
  ...
  // Avoid an SSR/client hydration mismatch: next-themes only resolves the
  // active theme after mount, so render a stable (light) map until then.
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className={`font-medium px-2 py-0.5 rounded-md bg-white/95 dark:bg-black/95 text-black dark:text-white border border-gray-200 dark:border-gray-700 shadow-sm ${labelClassName}`}>
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
